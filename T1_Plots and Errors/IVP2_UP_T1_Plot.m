...
numerical_100 = load('IVP2_UPWIND_T1_X100_CFL1.dat');
numerical_400 = load('IVP2_UPWIND_T1_X400_CFL1.dat');
numerical_2000 = load('IVP2_UPWIND_T1_X2000_CFL1.dat');
...
legend('Analytical', 'Numerical (X100)', 'Location', 'northwest', 'FontSize', 12);
grid on;
...
legend('Analytical', 'Numerical (X400)', 'Location', 'northwest', 'FontSize', 12);
grid on;
...
legend('Analytical', 'Numerical (X2000)', 'Location', 'northwest', 'FontSize', 12);
grid on;
...
sgtitle('IVP2 UPWIND T=1 CFL=1', 'FontSize', 16);
